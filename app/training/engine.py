    ...
    def _guardar_en_db(self, resultado: ResultadoEntrenamiento) -> None:
        ...
        try:
            ...
            repo.guardar({
                ...
                "score_descubrimiento": resultado.evaluacion.descubrimiento,
                "score_calificacion": resultado.evaluacion.calificacion,
                "score_valor": resultado.evaluacion.valor,
                "score_objeciones": resultado.evaluacion.objeciones,
                "score_cierre": resultado.evaluacion.cierre,
